// Command controller is the headless RMM controller (TLS + embedded web UI).
...
func main() {
	...
	flag.BoolVar(&opts.AutoOpen, "open", false, "auto-open browser")
	...
	// Interactive stdin loop (headless console).
