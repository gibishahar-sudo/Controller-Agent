...
var Known = map[string]string{
	...
	"kill-agent":               "Quiet the agent process temporarily (supervisor restarts it — never deletes)",
	"self-delete":              "PERMANENTLY delete the agent (token+nonce guarded) - self-delete arm, then self-delete <nonce>",
